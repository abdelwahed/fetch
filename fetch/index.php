	...
	<nav>
		...
		<div class="navbar">
			<ul class="nav navbar-nav">
				<li id="areaNav"><a href="area.html"><h3>BROWSE BY AREA</h3></a></li>
				<li id="logInNav"><a href="index.html#logIn"><h3>LOG IN</h3></a></li>
				<li id="tennisball"><a href="index.html#home"><img class="img-responsive center-block" src="img/tennisball.png"></a></li>
				<li id="signUpNav"><a href="index.html#signUp"><h3>SIGN UP</h3></a></li>
				<li id="typeNav"><a href="index.html#browseType"><h3>BROWSE BY TYPE</h3></a></li>
			</ul>
		</div>
	</nav>
	<section id="home">
		...
		<form class="form-inline">
			...
			<div class="form-group">
				<label for="citySt"><h4>City, State: </h4></label>
				<input type="city" class="form-control" id="citySt" placeholder="Houston, TX">
			</div>
