...
function whiteList()
{
    ...
    if (isset($_POST)) {
        ...
        /**
         * This is the final step in checking whether the white list is valid. If the
         * amount of form input names matching the white list equals the amount of
         * items found in the $_POST array, and the amount of form input names does
         * not equal 0, then the white list is valid.
         */
